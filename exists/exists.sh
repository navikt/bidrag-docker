...
# 2) teller antall ganger teksten "HTTP/2.0 404" kommer i head requesten etter manifestet
# 3a) når antall av "HTTP/2.0 404" er 0, så blir "not found" satt false
#     - hvis antall av "HTTP/2.0 401" er 1, så blir "not found" satt til false
